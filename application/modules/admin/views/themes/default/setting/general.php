      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          <div style="background: white; padding: 20px">
            <form class="form-horizontal" id="setting" action="<?= site_url('admin/setting/general') ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="">Nama Folder Template</label>
                <input type="text" name="template" placeholder="Folder Template" value="<?= @$setting->template ?>" class="form-control" required>
              </div>
              <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          <div style="background: white; padding: 20px">
            ...
            <div class="form-group">
              <label>Foto Direktur</label>
              <input type="hidden" name="foto_direktur_" value="<?= @$setting->foto_direktur ?>">
              <input type="file" name="foto_direktur" placeholder="Logo" class="form-control input-sm" accept="image/*" require>
            </div>
            <?= @$post->sambutan ?>
            <div class="form-group">
              <label>Sambutan Direktur</label>
              <textarea class="ckeditor" id="editor-standar" rows="7" name="sambutan" placeholder="Enter Post Title"><?= @$setting->sambutan ?></textarea>
            </div>
            <div class="form-group">
...
<script src="https://demo.dewankomputer.com/php/dewan-ckeditor/ckeditor-full/ckeditor.js"></script>
<script>
