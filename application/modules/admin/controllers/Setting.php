...
class Setting extends AdminController
{
    ...
    public function general()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($_FILES['foto_direktur']['error'] == 0) {
                ...
                $foto = $this->input->post('foto_direktur_');
            }
            ...
            $this->setting->cek_setting('foto_direktur')
                ? $this->setting->update_setting('foto_direktur', $foto)
                : $this->setting->insert_setting('foto_direktur', $foto);
